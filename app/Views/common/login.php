                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center mt-4">
                                    <h1 class="h2">Selamat Datang di CodeIgniter 4 Starter Panel</h1>
                                    <p class="lead">
                                ...
                                <div class="m-sm-4">
                                    ...
                                    <form action="<?= base_url('GetLogin'); ?>" method="POST">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="email" name="inputEmail" placeholder="Masukkan email" />
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Password</label>
                                            <input class="form-control form-control-lg" type="password" name="inputPassword" placeholder="Masukkan password" />
                                            <small>
