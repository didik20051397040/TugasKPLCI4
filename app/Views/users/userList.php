...
<div class="row">
    <div class="col-12 col-lg-8 col-xxl-8 d-flex">
        <div class="card flex-fill">
            <div class="card-header">
                <h5 class="card-title mb-0">Users List <button class="btn btn-primary btn-sm float-end btnAdd" data-bs-toggle="modal" data-bs-target="#formUserModal">Buat User Baru</button></h5>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        ...
                                        <?php if ($users['username'] != session()->get('username')) : ?>
                                            <form action="<?= base_url('users/deleteUser/' . $users['userID']); ?>" method="post" class="d-inline">
                                                ...
                                                <button class="btn btn-danger btn-sm" onclick="return confirm('Are you sure delete <?= $users['username']; ?> ?')">Hapus</button>
                                            </form>
                                        <?php endif; ?>
                                    </td>
                                </tr>
    ...
    <div class="col-12 col-lg-4 col-xxl-4 d-flex">
        <div class="card flex-fill">
            <div class="card-header">
                <h5 class="card-title mb-0">User Roles <button class="btn btn-primary btn-sm float-end btnAddRole" data-bs-toggle="modal" data-bs-target="#formRoleModal">Buat Role Baru</button></h5>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('users/createUser'); ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="inputFullname" class="col-form-label">Nama Lengkap:</label>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('users/createRole'); ?> " method="post">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="inputRoleName" class="form-label">Tambah Role</label>
                        <input type="text" class="form-control" id="inputRoleName" name="inputRoleName" placeholder=" Nama Role ">
                    </div>
                </div>
                <div class="modal-footer">
